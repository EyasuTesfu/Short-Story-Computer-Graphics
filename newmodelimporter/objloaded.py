...
chibi_indices, chibi_buffer = ObjLoader.load_model(
    "newmodelimporter/meshes/Dog/dog.obj")
...
# glBufferData(GL_ARRAY_BUFFER, monkey_buffer.nbytes,
#              monkey_buffer, GL_STATIC_DRAW)

# # monkey vertices
# glEnableVertexAttribArray(0)
# glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE,
#                       monkey_buffer.itemsize * 8, ctypes.c_void_p(0))
# # monkey textures
# glEnableVertexAttribArray(1)
# glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE,
#                       monkey_buffer.itemsize * 8, ctypes.c_void_p(12))
# # monkey normals
# glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE,
#                       monkey_buffer.itemsize * 8, ctypes.c_void_p(20))
# glEnableVertexAttribArray(2)


textures = glGenTextures(2)
load_texture("newmodelimporter/meshes/Dog/dog.jpg", textures[0])
